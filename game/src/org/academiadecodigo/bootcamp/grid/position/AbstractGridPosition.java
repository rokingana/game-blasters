...
/**
 * Base skeleton for a grid2 position2
 *
 * @see GridPosition
 */
public abstract class AbstractGridPosition implements GridPosition {
    ...
    /**
     * Construct a new grid2 position2 at a specific column and row
     *
     * @param col   the column of the grid2 position2
     * @param row   the row of the grid2 position2
     * @param grid  the grid2 in which the position2 will be displayed
     */
